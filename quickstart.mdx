...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    If you encounter any console errors while running the preview:
    - Make sure you're in the correct directory where your `mint.json` file is located
    - Check that all dependencies are properly installed
    - Review the error message in your terminal for specific troubleshooting steps
    - Try running `mintlify install` before running the dev command again
  </Accordion>
</AccordionGroup>
