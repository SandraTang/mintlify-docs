...
<Warning>
  El contenido que deseas reutilizar debe estar dentro del directorio `snippets` para
...
<Warning>
  MDX no se compila dentro del cuerpo de una función flecha. Mantente en la sintaxis HTML
