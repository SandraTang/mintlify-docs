...
1. Agrega contenido a tu archivo de fragmento que deseas reutilizar en múltiples
   ubicaciones. Opcionalmente, puedes agregar variables que se pueden completar a través
   de props cuando importes el fragmento.
...
<Warning>
  MDX no se compila dentro del cuerpo de una función flecha. Mantente en la
